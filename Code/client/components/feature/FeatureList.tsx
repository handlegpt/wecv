  ...
  return <>
    ...
    <section className="py-20 bg-white">
      <div className="container max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold tracking-tight text-center">WeCV AI 功能特色</h2>
        <p className="mt-2 text-lg text-center text-gray-600">查看我们强大的功能列表。</p>
        <div className="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
          ...
          <div className="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
            ...
            <h4 className="text-xl font-medium text-gray-700">免费使用</h4>
            <p className="text-base text-center text-gray-500">完全免费使用，无隐藏费用，无任何限制。</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
            ...
            <h4 className="text-xl font-medium text-gray-700">开源项目</h4>
            <p className="text-base text-center text-gray-500">完全开源 - 您可以添加、修改和自定义任何功能。</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
            ...
            <h4 className="text-xl font-medium text-gray-700">多格式导出</h4>
            <p className="text-base text-center text-gray-500">支持导出为PDF、HTML、图片和Word格式。</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
            ...
            <h4 className="text-xl font-medium text-gray-700">强大API</h4>
            <p className="text-base text-center text-gray-500">提供强大的API接口，支持程序化创建和下载简历。</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
            ...
            <h4 className="text-xl font-medium text-gray-700">安全可靠</h4>
            <p className="text-base text-center text-gray-500">所有通信都经过加密，数据存储在领先的云服务提供商。</p>
          </div>
